...
public class OVRGrabber : MonoBehaviour
{
    ...
    public float throwStrength = 1.5f;
    // Grab with either index trigger or hand trigger
    public bool indexOrHandTrigger = true;
   ...
   [SerializeField]
    ...
    void OnUpdatedAnchors()
    {
        ...
        m_prevFlex = indexOrHandTrigger ? OVRInput.Get(OVRInput.Axis1D.PrimaryIndexTrigger, m_controller) :
